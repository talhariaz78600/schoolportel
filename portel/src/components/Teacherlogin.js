...
function Teacherlogin() {
   ...
   const {teacherlogin}=context;
    const [adminv,adminf]=useState({idcard:"",email:"",password:""});
    const onchange=(e)=>{
        e.preventDefault();
    ...
    const onclick= async(e)=>{
        e.preventDefault();
        teacherlogin(adminv.email,adminv.password,adminv.idcard,host)
         ...
         <div className="container-fluid" style={{backgroundColor:"#084C61",height:"700px"}}>
                <div className="row justify-content-center">
                    <div className="col-md-4 mt-5 ">
                        <div className="container" style={{border:"2px solid black", borderRadius: "9px",marginTop:"80px", backgroundColor: "#084C61", height: "300px"}}>
                            <div className="row">
