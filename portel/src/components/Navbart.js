                    ...
                    <div className="row ">
                        <div className="col-md-3 col-12 border bg-light order-md-1">
                            <div className="navbar">
                                <h3 className='m-auto text-primary'>Teacher</h3>
                        ...
                        <div className="col-6 col-md-4 d-flex navbar m-0 justify-content-end bg-light order-md-3">
                            {!localStorage.getItem('sttoken') ? <div>
                            ...
                            <div className="navbar navbar-expand-md p-0">
                                ...
                                <div className="collapse navbar-collapse  w-100 p-0" id="navebar">
                                    ...
                                    <ul className="navbar-nav text-center">
                                        ...
                                        <li className="nav-item">
                                            <Link className={`nav-link  ${location.pathname === "/profile" ? "active" : ""} text-primary m-1 `} to="/teacherprofile">Profile</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className={`nav-link  ${location.pathname === "/classstudent" ? "active" : ""} text-primary m-1`} to="/classstudent">Students</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className={`nav-link  ${location.pathname === "/attendence" ? "active" : ""} text-primary m-1`} to="/attendance">Attendance</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className={`nav-link  ${location.pathname === "/text" ? "active" : ""} text-primary m-1`} to="/text">Test</Link>
                                        </li>
